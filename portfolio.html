    ...
    <section id="products" class="section section-a with-overflow">
            ...
            <div class="part-wrapper">
              <div class="item-list row row-cols-1 row-cols-md-2 row-cols-lg-2 g-5 anim-list">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Candy Pink</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Foods</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <p class="price">$19</p>
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/img-square-8.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
        ...
        <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Tee Shirt</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Clothing</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <p class="price">$29</p>
                ...
                <div class="col">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    <div class="item-img rounded-md">
                      <img class="fit" src="img/items/img-square-9.jpg" alt="team member">
                    </div>
                    <div class="item-header">
                      <div class="row">
                        <div class="col text-end">
                    ...
                    <div class="item-body item-body-glass rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Thecube</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Painting</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <p class="price">$19</p>
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    ...
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Neutraco oil</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Natural and pure organic</span>
                            </p>
                          </div>
                          <div class="col-auto">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    ...
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Orange chair</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Home decoration</span>
                            </p>
                          </div>
                          <div class="col-auto">
                            <span class="btn btn-icon-a">
                  ...
                  <a class="item item-image-f anim-ready anim-visible" href="item.html#or_an_url" data-anim-visible="fade">
                    ...
                    <div class="item-body rounded-md">
                      <div class="desc">
                        <div class="row align-items-end">
                          <div class="col">
                            <h4 class="title">Summer dress</h4>
                            <p class="category mb-0">
                              <span class="text-muted-2">Clothing</span>
                            </p>
                          </div>
